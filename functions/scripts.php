...
function wpex_load_scripts()
{
	 ...
	 *** CSS
	 *******************/
	if (!is_page_template('templates/home-landing.php')) {
		...
		wp_enqueue_style('home-reset', 'https://cdn.jsdelivr.net/npm/normalize.css@8.0.1/normalize.css');
		wp_enqueue_style('home-landing', get_stylesheet_directory_uri() . '/styles/css/landing.css', array(), filemtime(get_stylesheet_directory() . '/styles/css/style.css'));
		wp_enqueue_style('adobe-fonts', 'https://use.typekit.net/uli7xqz.css');
	}
